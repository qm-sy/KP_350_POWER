...
{
    ac_220.power_ch1 = ac_220.power_ch2 = ac_220.power_ch3 = ac_220.power_ch4 = 1;
...
void Tim1_ISR( void ) interrupt 3   //1ms
{
    ...
    {
        ac_220.zero_flag = 0;
        ac_220.power_ch1 = ac_220.power_ch2 = ac_220.power_ch3 = ac_220.power_ch4 = 0;
